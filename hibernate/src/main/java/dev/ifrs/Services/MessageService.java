...
public class MessageService {
    ...
    public User addMessage(@PathParam("name") String name, @PathParam("text") String text, @PathParam("hash") String hash){
        ...
        Channel channel = Channel.find("hash", hash).firstResult();
